...
secrets = json.loads(os.getenv('HOME') + '/.ssh/drc.secrets.json')
ACCESS_TOKEN = secrets.githubAccessToken;
GITHUB_LOGIN = secrets.gitHubUserName;

# (optional) PRs with this label (e.g 'in progress') will be grayed out on the list
WIP_LABEL = 'DO NOT MERGE'

# (optional) Filter the PRs by an organization, labels, etc. E.g 'org:YourOrg -label:dropped'
FILTERS = 'org:datarecognitioncorp'
