...
alias diff='diff -b'
alias dird=lsd
alias ema='echo_do vi $GAC_CFG_DIR/aliases.sh'
alias emf='echo_do vi $GAC_CFG_DIR/functions.bash'
alias eml='echo_do vi $GAC_CFG_DIR/login.bash'
alias ewd='echo_do vi $GAC_CFG_DIR/work/drc.bash'
