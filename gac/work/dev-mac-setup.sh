...
cd ~/.config/gac
brew bundle install --file ${GAC_MACHINE_ABBR}.Brewfile | tee -a brew-bundle-install--${GAC_MACHINE_ABBR}.Brewfile.log


# File search (like: find * | xargs grep *)
# brew install ack

# Download over HTTP
# brew install wget
  # Installs perl (version 2)

# Development tools - command line
# brew install groovy
# Installs java version 12. Other options: java11, java6
# brew install oracle-jdk
# brew install oracle-jdk-javadoc

## oath-toolkit and assume-role were for AWS account management.
...
# brew cask install visual-studio-codeo
